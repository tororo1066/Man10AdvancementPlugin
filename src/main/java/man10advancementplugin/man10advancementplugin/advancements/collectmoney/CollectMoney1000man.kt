...
object CollectMoney1000man : Advancement(plugin,"collect_money_1000man") {

    init {
        setParent(CollectMoney100man.key)
        addCriteria("collect1000man", TriggerType.IMPOSSIBLE){}
        setDisplay {
            it.setTitle("大金持ち")
            it.setDescription("1000万円を所持する")
            it.setIcon(Material.GOLD_INGOT,"{CustomModelData:1}")
        }
    }
}